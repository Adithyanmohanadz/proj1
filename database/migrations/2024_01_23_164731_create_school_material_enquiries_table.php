...
return new class extends Migration
{
    ...
    {
        Schema::create('school_material_enquiries', function (Blueprint $table) {
            $table->id();
            $table->string('school_material_enquiry_id', 100)->unique();
    ...
    {
        Schema::dropIfExists('school_material_enquiries');
    }
};
