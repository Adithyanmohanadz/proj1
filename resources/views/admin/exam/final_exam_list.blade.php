                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="{{route('finalExam.index')}}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Add    </a>
                        ...
                        <table class="table table-flush" id="exam-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">{{$rows->final_exam_name}}</p>
                                    </td>
                                    <td>
