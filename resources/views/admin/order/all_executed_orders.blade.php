                ...
                <div class="card-body px-0 pb-0">
                    <div class="table-responsive">
                        <table class="table table-flush " id="total-order">
                            ...
                            <tbody>
                                @foreach ($executedOrders as $rows)
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-sm">
                                        <a href="{{ route('executedOrderById.index', ['consolidate_order_id' => $rows->consolidate_order_id]) }}"  class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="View order">
