                                ...
                                <div class="col-12 col-sm-6 mt-3">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <input class="  form-control" disabled
                                            value="{{ $consolidateOrder->executed_date }}" type="text" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                                ...
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <input value="{{ $consolidateOrder->tracking_id }}" disabled class=" form-control"
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-6">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <input value="{{ $consolidateOrder->method_of_delivery }}" disabled class="  form-control"
                                            name="method_of_delivery" type="text" />
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <div class="input-group input-group-dynamic">
                                        ...
                                        <textarea class=" form-control" disabled type="text" name="" id="" rows="1"> {{ $consolidateOrder->remark }}</textarea>
                                    </div>
                                </div>
                            </div>
