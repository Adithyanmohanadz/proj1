...
@section('page_content_body')
    <div class="container-fluid py-1 mb-0">
        <div class="row">
            <div class="col-12">
                <div class="card">
                                ...
                                <table class="table table-flush " id="total-order">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Order
                                                date</th>
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">
                                                Coordinator</th>
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">executed
                                                by</th>
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">executed
                                                date</th>
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder "> challan
                                            </th>
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder "> Action
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($dispatchOrders as $rows)
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-sm">
                                                    <a href="{{ route('dispatchOrderById.index', ['consolidate_order_id' => $rows->consolidate_order_id]) }}" class="mx-3" data-bs-toggle="tooltip"
