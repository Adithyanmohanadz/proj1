                                ...
                                <tbody>
                                    @foreach ($students as $rows)
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0 text-md">{{ $rows->student->school->school_name }}</h6>
                                            </td>
                                            <td>
                                                <h6 class="mb-0 text-md">{{ $rows->student->student_name }}</h6>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->product->product_name }}</p>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->mc->level }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->finalExam->final_exam_name }}</p>
                                            </td>
                                            
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->finalExam->exam_start_date_time }} </p>
                                            </td>
                                            ...
                                            <td class="text-sm text-center">
                                                <form action="">
                                                    ...
                                                    <input type="hidden" name="school_id" value="{{ $rows->student->school->school_id }}">
                                                    ...
                                                    <input type="hidden" name="exam_id" value="{{ $rows->finalExam->final_exam_id }}">
