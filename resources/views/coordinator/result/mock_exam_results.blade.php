                                ...
                                <tbody>
                                    @foreach ($students as $rows)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->mockExam->mock_exam_name }}</p>
                                            </td>
                                            
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $rows->mockExam->exam_start_date_time }} </p>
                                            </td>
                                            ...
                                            <td class="text-sm text-center">
                                                <form action="">
                                                    ...
                                                    <input type="hidden" name="exam_id" value="{{ $rows->mockExam->mock_exam_id }}">
