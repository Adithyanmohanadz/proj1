        ...
        <div class="col-12">
            <div class="row ">
                <div class="col-12 col-lg-11 m-auto ">
                    <div class="card">
                        <div class="card-body">
                            <form id="coordinatorStudentCreationForm" data-route="{{route('coordinator.studentRegistrationStore')}}" >
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <select class="form-control " name="school_id" id="choices-school">
                                                        ...
                                                        @foreach ($schools as $rows)
                                                          <option value="{{$rows->school_id}}">{{$rows->school_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <select class="form-control " name="product_id" id="cs_product_id">
                                            ...
                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <select class="form-control " disabled name="material_category_id" id="cs_material_category_id">
...
<script>
    var levelfetchUrl = "{{route('coordinator.school.fetch_level')}}";
    var allStudentUrl = "{{route('coordinator.coordinatorStudentList')}}";

    if (document.getElementById('cs_product_id')) {
        var element = document.getElementById('cs_product_id');
