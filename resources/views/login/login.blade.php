            ...
            <div class="row mt-lg-n12 mt-md-n12 mt-n12 justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card mt-8">
                        ...
                        @endif
                        <div class="card-body">
                            <form class="text-start" action="{{ route('login.post') }}" method="POST">
                                @csrf
                ...
                <a href="sign_up" class="text-dark text-gradient font-weight-bold">Sign up</a>
              </p> -->

                            <div class="dropdown">
                                <button class="col-12 btn bg-gradient-secondary  dropdown-toggle" type="button"
                                    id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                    other users
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <!-- <li><a class="dropdown-item" href="inventory_dashboard">Inventory</a></li> -->
                                    <li><a class="dropdown-item"
                                            href="{{ route('coordinatorDashboard') }}">Coordinator</a></li>
                                    <li><a class="dropdown-item" href="{{ route('schoolDashboard') }}">School</a></li>
                                    <li><a class="dropdown-item" href="{{ route('studentDashboard') }}">Student</a>
                                    </li>
                                </ul>
                            </div>
