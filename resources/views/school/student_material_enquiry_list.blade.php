...
@section('page_content_body')
                            ...
                            <table class="table table-flush" id="Level-list">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Student Name
                                        </th>
                                ...
                                <tbody id="table_div">
                                    @foreach ($allEnquires as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $row->student_name }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-sm">
                                                <a href="#" value="{{$row->material_enquiry_id}}" id="materialAvailableStatus" 
                                                    class="ms-3 btn btn-sm btn-primary" data-bs-toggle="tooltip"
    ...
    <script>
                var availableUrl = "{{ route('studentMaterialEnquiry.materialAvailable')}}"
