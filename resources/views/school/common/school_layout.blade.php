    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active== 'dashboard') ? 'active bg-dark' : '' ;?>" href="{{route('schoolDashboard')}}">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_profile') ? 'active bg-dark' : '' ;?> " href="{{route('school.schoolProfile')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons ms-1 opacity-10">school</i>
                      </div>
                      <span class="nav-link-text ms-2">School Profile</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_me') ? 'active bg-dark' : '' ;?> " href="{{route('studentMaterialEnquiry')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons ms-1 opacity-10">school</i>
                      </div>
                      <span class="nav-link-text ms-2">Students Material Enquiry</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_ec') ? 'active bg-dark' : '' ;?> " href="{{route('schoolEnquiry.index')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons ms-1 opacity-10">school</i>
                      </div>
                      <span class="nav-link-text ms-2"> Material Enquiry To Coordinator</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#student" class="nav-link text-white <?php echo ($active == 'school_student_creation' || $active == 'school_student_list') ? 'active bg-dark' : '' ;?>" aria-controls="student" role="button" aria-expanded="false">
                    <i class="fas fa-user-graduate opacity-10" style='font-size:19px'></i>
                      <span class="nav-link-text ms-2 ">Student</span>
                    </a>
                    <div class="collapse  <?php echo ($active == 'school_student_creation' || $active == 'school_student_list') ? 'show' : '' ;?> " id="student">
                      <ul class="nav ">
                        <li class="nav-item  ">
                          <a class="nav-link text-white <?php echo ($active == 'school_student_creation') ? 'active' : '' ;?>" href="{{route('school.studentRegistration')}}">
                            <span class="sidenav-mini-icon"> AS </span>
                            <span class="sidenav-normal  ms-2  ps-1">Add Student</span>
                          </a>
                        </li>
                        <li class="nav-item ">
                          <a class="nav-link text-white <?php echo ($active == 'school_student_list') ? 'active' : '' ;?>" href="{{route('school.schoolStudentList')}}">
                            <span class="sidenav-mini-icon"> SL </span>
                            <span class="sidenav-normal  ms-2  ps-1">Student list </span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#exam" class="nav-link text-white <?php echo ($active == 'school_mock_list' ||  $active == 'school_final_list') ? 'active bg-dark' : '' ;?>" aria-controls="exam" role="button" aria-expanded="false">
                      <i class="material-symbols-outlined opacity-10">stylus</i>
                      <span class="nav-link-text ms-2 ">Exam</span>
                    </a>
                    <div class="collapse  <?php echo ($active == 'school_mock_list' ||  $active == 'school_final_list') ? 'show' : '' ;?> " id="exam">
                      <ul class="nav ">
                        <li class="nav-item  ">
                          <a class="nav-link text-white <?php echo ($active == 'school_mock_list') ? 'active' : '' ;?>" href="{{route('school.SchoolViewMockExamList')}}">
                            <span class="sidenav-mini-icon"> MT </span>
                            <span class="sidenav-normal  ms-2  ps-1">Mock Test List</span>
                          </a>
                        </li> 
                        <li class="nav-item ">
                          <a class="nav-link text-white <?php echo ($active == 'school_final_list') ? 'active' : '' ;?>" href="{{route('school.SchoolViewFinalExamList')}}">
                            <span class="sidenav-mini-icon"> FT </span>
                            <span class="sidenav-normal  ms-2  ps-1">Final Test List</span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_result') ? 'active bg-dark' : '' ;?> " href="school_result">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_notification') ? 'active bg-dark' : '' ;?> " href="{{route('schoolNotification')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_resources') ? 'active bg-dark' : '' ;?> " href="{{route('allResource')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-symbols-outlined opacity-10">note_stack</i>
                      </div>
                      <span class="nav-link-text ms-2">Resources</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($active == 'school_order') ? 'active bg-dark' : '' ;?> " href="{{route('uploadOrder.index')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-symbols-outlined opacity-10">docs_add_on</i>
                      </div> 
                      <span class="nav-link-text ms-2">School Order</span>
                    </a>
                  </li>  
