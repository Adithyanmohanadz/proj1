        ...
        <div class="col-12">
            <div class="row ">
                <div class="col-12 col-lg-11 m-auto ">
                    <div class="card">
                        <div class="card-body">
                            <form id="StudentCreationForm" data-route="{{route('school.studentRegistrationStore')}}" >
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <select class="form-control " name="product_id" id="ss_product_id">
                                            ...
                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <select class="form-control " disabled name="material_category_id" id="ss_material_category_id">
...
<script>
    var levelfetchUrl = "{{route('school.student.fetch_level')}}";
    var All_student_list_url = "{{route('school.schoolStudentList')}}"
    if (document.getElementById('ss_product_id')) {
        var element = document.getElementById('ss_product_id');
