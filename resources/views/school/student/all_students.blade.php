                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="{{route('school.studentRegistration')}}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Add  </a>
                        ...
                        <table class="table table-flush" id="student-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">{{$rows->studentCurrentRecord->product->product_name}}</p>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">{{$rows->studentCurrentRecord->mc->level}}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-sm">
                                        <a href="school_student_creation" class="ms-3" data-bs-toggle="tooltip" data-bs-original-title="Edit Student">
