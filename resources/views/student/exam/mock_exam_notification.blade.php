                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="  border-radius-xl bg-white ">
                                ...
                                <div class="mt-4">
                                    @if($mockExams)
                                    <h3 class="font-weight-bolder mb-0">{{$mockExams->mock_exam_name}}</h3>
                                    <div class="row mt-3">
                                        <div class="col-sm-4">
                                            <p class=" text-xs m-0">Product </p>
                                            <h6 class="   mb-5">
                                                {{$mockExams->product->product_name}}
                                            </h6>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <h6 class="text-uppercase mb-5">
                                                {{$mockExams->exam_start_date_time}}
                                            </h6>
                                        </div>
                                        <div class="col-sm-4">
                                            <p class=" text-xs m-0">End Date & Time</p>
                                            <h6 class="text-uppercase mb-5">
                                                {{$mockExams->exam_end_date_time}}
                                            </h6>
                                        </div>
                                        <div class="button-row d-flex mt-4 ">
                                            <button class="ms-auto mb-0 px-6 btn bg-gradient-dark " type="button" data-bs-toggle="modal" data-bs-target="#mockConfirmModel">Start The Exam</button>
                                        </div>

                                        <!-- modal -->
                                        <div class="modal fade" id="mockConfirmModel" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
                                            <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="" id="mockExamConfirmForm" data-route="{{route('mockExamConfirm')}}">
                                                    <div class="modal-body">
                                                        <input type="hidden" name="mock_exam_id" id="mock_exam_id" value="{{$mockExams->mock_exam_id}}">
                            ...
                            <script>
                                var MockgoogleLink = '{{ $mockExams->google_link }}';
                            </script>
                            @else
                            <p>No mock exams found.</p>
                            @endif
                        </div>
                    </div>
                </div>
